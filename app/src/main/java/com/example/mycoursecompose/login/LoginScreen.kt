...
import com.example.mycoursecompose.R
...
fun LoginDivider() {
    Row(Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
        ...
        Text(
            ...
            fontSize = 12.sp, fontWeight = FontWeight.Bold, color = Color(0xFFB5B5B5)
        )
        HorizontalDivider(
            Modifier
                .background(Color(0xFFF9F9F9))
...
fun LoginButton(loginEnable: Boolean, loginViewModel: LoginViewModel) {
    Button(
        ...
        colors = ButtonDefaults.buttonColors(
            ...
            disabledContainerColor = Color(0xFF87C8F9),
...
fun Password(password: String, onTextChanged: (String) -> Unit) {
    ...
    TextField(
        value = password, onValueChange = { onTextChanged(it) }, Modifier.fillMaxWidth(),
...
fun ImageLogo(modifier: Modifier) {
    Image(
        painter = painterResource(R.drawable.logo_tipografia), contentDescription = "logo",
        modifier = modifier
    )
}
